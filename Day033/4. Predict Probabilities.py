...
# Probability for first 5 test samples
proba = rf.predict_proba(X_test[:5])
print(proba)

# Predictions where the forest is very confident (>0.8)
confident_mask = np.max(proba, axis=1) > 0.8
print("Confident predictions:", confident_mask)
