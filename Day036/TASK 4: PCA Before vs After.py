...
print("Accuracy (2 PCA components):", accuracy_score(y_test, predictions))

# Logistic Regression on original 4 features
model_full = LogisticRegression()
model_full.fit(X_train_scaled, y_train)
predictions_full = model_full.predict(X_test_scaled)
print("Accuracy (4 original features):", accuracy_score(y_test, predictions_full))